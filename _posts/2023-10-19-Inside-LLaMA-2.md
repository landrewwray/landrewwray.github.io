...
Let’s take a closer look at just the input dictionary, which has a <a href = "/docs/Llama-2/input-vs-output.md" target = "_blank" rel = "noreferrer noopener">similar structure</a> to the output token dictionary.  First, some pictures:
