...
Comic courtesy of [SMBC](https://www.smbc-comics.com/comic/conscious-6){:target="_blank" rel="noopener"}:  
...
it generates text.  Llama-2 is a popular LLM that was released by Meta on July 21, 2023, with [this accompanying paper](https://arxiv.org/abs/2307.09288){:target="_blank" rel="noopener"}.  Some related learning resources are listed at the end of the article.
