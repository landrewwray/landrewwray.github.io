### Layer 0, Head 0 KEY: closest word mappings ranked by <token|Wk vector> amplitude
...
**Corresponding <token|Wk vector>.abs() values:**  
```
...
### Layer 0, Head 0 QUERY: closest word mappings ranked by <token|Wq_vector> amplitude
...
**Corresponding <token|Wq vector>.abs() values:**  
```
